            ...
            switch (option) {
                ...
                case 4:
                    ...
                    const result = searchKey === "id" ?
                        this.productManager.findProductBy("id", parseInt(searchValue)) :
                        this.productManager.findProductBy(searchKey, searchKey === "id" ? parseInt(searchValue) : searchKey === "price" ? parseFloat(searchValue) : searchValue);
